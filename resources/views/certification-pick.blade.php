...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="left">
                <image src={{asset('image/cisco.png')}}>
                ...
                <button class="btn btn-primary"  style="color : white; border-radius: 10px; background-color: #1b294a;width:85%;margin-left:5%;"> Apply </button>
                </a>
            </div>
            <div class="right">
